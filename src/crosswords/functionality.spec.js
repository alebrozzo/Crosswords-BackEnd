...
describe('Word search on word list, no avoided words', () => {
    const wordList = 'ALE DA LE PUS ABA NUEZ ADAN ZYMOTECHNICAL BCATORCELETRAS DIEZLETRAS ZYMOSES ZYMOSIS AAHED BABY LA PE LUZ MES';
...
describe('Word search on word list, with avoided words', () => {
    const wordList = 'ALE DA LE PUS ABA NUEZ ADAN ZYMOTECHNICAL BCATORCELETRAS DIEZLETRAS ZYMOSES ZYMOSIS AAHED BABY BURN OBJ LA PE LUZ MES';
    const wordArray = wordList.split(' ');
...
describe('Get used words', () => {
    ...
    it('should return all 5 words', () => {
        const crossword = functionality.writeWord(functionality.writeWord(functionality.writeWord(functionality.writeWord(functionality.writeWord(structure.setWordNumbers(cwInit), 'H', 0, 'ALE'), 'H', 4, 'NUEZ'), 'V', 3, 'LUZ'), 'V', 4, 'PE'), 'H', 3, 'PUS');
        // [ A, L, E, #, _ ]
        // [ _, _, #, L, _ ]
        // [ _, #, P, U, S ]
        // [ N, U, E, Z, # ]
    ...
    it('should return all words', () => {
        let crossword = functionality.writeWord(functionality.writeWord(functionality.writeWord(functionality.writeWord(functionality.writeWord(structure.setWordNumbers(cwInit), 'H', 0, 'ALE'), 'H', 4, 'NUEZ'), 'V', 3, 'LUZ'), 'V', 4, 'PE'), 'H', 3, 'PUS');
        crossword = functionality.writeWord(functionality.writeWord(functionality.writeWord(functionality.writeWord(functionality.writeWord(structure.setWordNumbers(crossword), 'V', 0, 'ADAN'), 'H', 1, 'DA'), 'V', 1, 'LA'), 'H', 2, 'LE'), 'V', 2, 'MES');
        // [ A, L, E, #, M ]
        // [ D, A, #, L, E ]
        // [ A, #, P, U, S ]
        // [ N, U, E, Z, # ]
