...
describe("Calculate word length", () => {
    ...
    it("should return a length of 3", () => {
        expect(
            structure.getWordLength(grid, 0, 0, "H"),
            "starting on cw limit, ending on black box, horizontal"
        ).to.equal(3);
    });

    it("should return a length of 2", () => {
        expect(
            structure.getWordLength(grid, 1, 3, "H"),
            "starting on black box, ending on cw limit, horizontal"
        ).to.equal(2);
    });

    it("should return a length of 2", () => {
        expect(
            structure.getWordLength(grid, 0, 1, "V"),
            "starting on cw limit, ending on black box, vertical"
        ).to.equal(2);
    });

    it("should return a length of 3", () => {
        expect(
            structure.getWordLength(grid, 1, 3, "V"),
            "starting on black box, ending on cw limit, vertical"
        ).to.equal(3);
    });

    it("should return a length of 5", () => {
        expect(
            structure.getWordLength(grid, 3, 0, "H"),
            "starting on cw limit, ending on cw limit, horizontal"
        ).to.equal(5);
    });

    it("should return a length of 4", () => {
        expect(structure.getWordLength(grid, 0, 0, "V"), "starting on cw limit, ending on cw limit, vertical").to.equal(
            4
        );
    });
});
